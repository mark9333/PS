...
namespace UserLogin
{
    public static class UserData
    {
        ...
        {
            _testUsers.Add(new User("Dimitar", "1234567", "121219***", DateTime.Today, DateTime.MaxValue, UserRoles.STUDENT));
            _testUsers.Add(new User("Georgi", "123456", "121219***", DateTime.Today, DateTime.MaxValue, UserRoles.STUDENT));
            _testUsers.Add(new User("Mark_1", "12345", "121219045", DateTime.Today, DateTime.MaxValue, UserRoles.ADMIN));
